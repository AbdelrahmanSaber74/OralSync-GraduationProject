...
{
    public class GetAllPostsByUserService : IGetAllPostsByUserService
    {
        private readonly AppDbContext _db;

        public GetAllPostsByUserService(AppDbContext db)
        {
            _db = db ?? throw new ArgumentNullException(nameof(db));
        }

        public async Task<object> GetAllPostsByUserAsync(string userId, string hostUrl)
        {
